# Six-panel manuscript figure of Papilio cresphontes & Zanthoxylum americanum
# Jeff Oliver
...
# Setup destination
plot.file <- paste0(outpath, butterfly.species, "-six-panel.jpg")
