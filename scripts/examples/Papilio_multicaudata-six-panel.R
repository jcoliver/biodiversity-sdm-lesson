# Script for six-panel figure of insect and one host plant
# Jeff Oliver
...
# Things to set:
butterfly_data_file <- "data/Papilio_multicaudata_data.csv"
plant_data_file <- "data/Fraxinus_velutina_data.csv"
butterfly_species <- "Papilio_multicaudata"
plant_species <- "Fraxinus_velutina"
outpath <- "output/"
