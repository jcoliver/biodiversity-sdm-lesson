# Script for six-panel figure of Papilio multicaudata & Fraxinus velutina
# Jeff Oliver
...
# Things to set:
butterfly.data.file <- "data/Papilio_multicaudata_data.csv"
plant.data.file <- "data/Fraxinus_velutina_data.csv"
butterfly.species <- "Papilio_multicaudata"
plant.species <- "Fraxinus_velutina"
outpath <- "output/"
