# Script to run forecast species distribution model for Aglais io & Urtica dioica
# Jeff Oliver
...
# Run species distribution modeling
butterfly_raster <- SDMForecast(data = butterfly_data)
plant_raster <- SDMForecast(data = plant_data)
...
plot_file <- paste0(outpath, outprefix, "-pairwise-future-prediction.pdf")
